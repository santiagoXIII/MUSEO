...
def main(page: ft.Page):
    ...
    sixdegress = ft.Audio(src="sixdegrees.mp3",volume=1,balance=0)
    page.overlay.append(sixdegress)
    ...
    incremento = ft.Audio(src="incremento.mp3",volume=1,balance=0)
    page.overlay.append(incremento)
    def StopAll():
        intro.pause()
        Pascal.pause()
        Leibniz.pause()
    ...
    btn41 = ElevatedButton(content=ft.Image(src="sixdegrees.jpg",width=img_width,height=img_height,border_radius=border_radius,semantics_label="sixdegress"),on_click=play_sixdegress)
    ...
    btn481 = ElevatedButton(content=ft.Image(src="nube.png",width=img_width,height=img_height,border_radius=border_radius,semantics_label="cloud"),on_click=play_nube)
    
    btn482=ElevatedButton(content=ft.Image(src="incremento.jpg",width=img_width,height=img_height,border_radius=border_radius,semantics_label="incrementode uso de Ia"),on_click=play_incremento)
                        ...
                        ft.Container(
                            ft.Column(
                                controls=[
                                    ...
                                    ft.Row(
                                        alignment="center",
                                        controls=[btn21,btn24,btn27,btn30]
                                    ),
                                    ft.Row(
                                        alignment="center",
                                        controls=[btn22,btn25,btn28,btn31]
                                    ),
                                    ft.Row(
                                        alignment="center",
                                        controls=[btn23,btn26,btn29,btn32]
                                    ),
                                    ElevatedButton(
                        ...
                        ft.Container(
                            ft.Column(
                                controls=[
                                    ...
                                    ft.Row(
                                        alignment="center",
                                        controls=[btn40,btn33,btn39,btn34]
                                    ),
                                    ft.Row(
                                        alignment="center",
                                        controls=[btn38,btn35,btn37,btn36]
                                    ),
                                    ft.Row(
                                        alignment="center",
                                        controls=[btn41,btn42]
                                    ),
                                    ft.ElevatedButton(
                            ...
                            ft.Column(
                                controls=[
                                    ...
                                    ft.Row(alignment="center",
                                        controls=[btn43,btn44,btn45,btn481]),
                                    ft.Row(alignment="center",
                                        controls=[btn46,btn47,btn48,btn482]),
                                    ElevatedButton(
